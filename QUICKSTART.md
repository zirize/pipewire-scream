...
```bash
# Using paplay
paplay -d Scream /usr/share/sounds/alsa/Front_Center.wav

# Using mpv
mpv --audio-device=pipewire/Scream your-audio-file.mp3

# Or set it as default sink
...
To send to a specific receiver:

```bash
pw-cli load-module libpipewire-module-scream-sender ip=192.168.1.100
```

Or configure in `scream-sender.conf`.
